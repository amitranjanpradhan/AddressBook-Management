...
public class AddressBookImplement implements MultipleAddressBook {
    ...
    public boolean makechoice() throws CsvException, IOException {
        System.out.println("enter \n1:add_contact \n2:view_by_city \n3:view_by_state \n4:edit_contact \n5:delete_contact" +
                ...
                "\n12:Write AddressBook in CSV \n13:Read AddressBook from CSV \n0:Quit");
        int check = obj.nextInt();
        boolean conditon = true;
        switch (check) {
            case 1:
    ...
    /**
     * This method will call the writeData method of OpenCSVwriter class which will create a csv file and store the data.
    ...
    /**
     * This method will call the readData method of OpenCSVwriter class which will read the csv file.
     * @throws IOException
     * @throws CsvException
     */
